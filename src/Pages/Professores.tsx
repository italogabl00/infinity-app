...
function Professores() {
  const [professores, setProfessores] = useState<Array<any>>([]);
          ...
          {filteredProfessoresCourse.map((professor) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                {professor.rede &&
                  professor.rede.split(", ").map((rede: any, i: number) => {
                    return (
                      <a
                        key={i}
                        href={rede}
                      ...
                      >
                        {rede.includes("instagram.com") ? (
                          <FaInstagramSquare
                            size={24}
                            style={{ color: "#FF0000" }}
                          />
                        ) : rede.includes("github.com") ? (
                          <FaGithubSquare
                            size={24}
                            style={{ color: "#FF0000" }}
                          />
                        ) : (
                          <FaLinkedin size={24} style={{ color: "#FF0000" }} />
                        )}
                      </a>
                    );
                  })}
...
function NavLink({ label, onClick, active }: NavlinkProps) {
  return (
    <li
